...
#     tester.set_test_mode_single("cosy_tts_python", json.dumps(empty_params_config))
...
#             status_code=500,
#             body="speech synthesizer has not been started",
#         )
...
#     tester.set_test_mode_single("cosy_tts_python", json.dumps(invalid_params_config))
